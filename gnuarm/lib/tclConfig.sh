...
# installed.
TCL_PREFIX='/g/gnuarm-4.0.2'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/g/gnuarm-4.0.2'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/g/gnu/insight-build/tcl/win -ltcl84'
...
TCL_INCLUDE_SPEC='-I/g/gnuarm-4.0.2/include'
...
# compiled.
TCL_SRC_DIR='/g/gnu/insight-6.4/tcl'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/g/gnu/insight-build/tcl/win -ltclstub84'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/g/gnuarm-4.0.2/lib -ltclstub84'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/g/gnu/insight-build/tcl/win/libtclstub84.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/g/gnuarm-4.0.2/lib/libtclstub84.a'
