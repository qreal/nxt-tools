...
# installed.
TK_PREFIX='/g/gnuarm-4.0.2'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/g/gnuarm-4.0.2'

# -I switch(es) to use to make all of the X11 include files accessible:
TK_XINCLUDES='-I"/g/gnu/insight-6.4/tk/xlib"'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/g/gnu/insight-build/tk/win -ltk84'
...
# compiled.
TK_SRC_DIR='/g/gnu/insight-6.4/tk'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/g/gnu/insight-build/tk/win -ltkstub84'
